...
async function seed() {
  ...
  const homeData = {
    ...
    footer: { companyName: 'Balaji Group of Companies', companyDescription: 'Balaji Group of Companies delivers reliable wind and solar infrastructure with strong engineering, multi-state execution experience, and end-to-end project support for large renewable developments.', address: '11/17, East Street, Shree Ranganarayanapuram, Perumanal, Tirunelveli, Tamil Nadu, 627106, India', email: 'hello@balajo-co.com', phone: '+91 9876543210', copyrightText: 'Balaji Group of Companies © All rights reserved 2025', creditLine: 'Made with ❤️ by Zerocodes.io' },
  };
  ...
  const contactData = {
    contactHero: { sectionLabel: 'Contact Us', headline: "Let's Talk About Your Next Project", subheadline: 'Join over 100 companies using clean, affordable energy from Balaji Group of Companies. Contact our team for a free assessment.' },
    contactInfoCards: [
  ...
  const showcaseSamples = [
    {
      ...
      overview: 'A landmark project involving the AGW 147 – 4.2 MW, one of India\'s largest onsite wind turbines. Balaji Group of Companies delivered this project with full turnkey responsibility.',
    ...
    },
    {
      ...
      overview: 'Balaji Group of Companies executed foundation installations for a large fleet of Regen wind turbines across South India, covering varied terrain and soil conditions.',
