...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ...
  // button per HTML, so Cancel buttons were submitting the form as they
  // unmounted the modal. Every real submit button passes type="submit".
  ({ variant = 'primary', size = 'md', loading = false, type = 'button', disabled, className, children, ...props }, ref) => {
    ...
    const variants = {
      ...
      secondary: 'bg-white text-gray-700 hover:bg-gray-50 focus:ring-forest-500 border border-gray-300',
